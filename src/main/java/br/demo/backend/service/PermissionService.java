...
public class PermissionService {
    ...
    public PermissionGetDTO save(PermissionPostDTO permissionDto) {
        ...
        return Implementacoes.tranform(permissionRepository.save(permission));
    }
    ...
    public Collection<PermissionGetDTO> findByProject(Long projectId) {
        ...
        return permissionRepository.findByProject(project).stream().map(Implementacoes::tranform).toList();
    }

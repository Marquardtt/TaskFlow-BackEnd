...
public class Implementacoes {
    ...
    public void setUserRepository(GroupRepository repo) {
        Implementacoes.groupRepository= repo;
    }
    ...
    public static MessageGetDTO tranform(Message obj){
        ...
        try {
            message.setDestinations(obj.getDestinations().stream().map(Implementacoes::tranform).toList());
    ...
    public static ChatGetDTO tranform(Chat obj){
        ...
        try {
            chat.setMessages(obj.getMessages().stream().map(Implementacoes::tranform).toList());
        }catch (NullPointerException ignore) {}
    ...
    private static ChatPrivateGetDTO tranform(ChatPrivate obj){
        ...
        try {
            chat.setUsers(obj.getUsers().stream().map(Implementacoes::tranformSimple).toList());
        } catch (NullPointerException ignore) {}
        return chat;
    }
    ...
    public static ProjectGetDTO tranform(Project obj){
        ...
        try {
            project.setPages(obj.getPages().stream().map(Implementacoes::tranform).toList());
        } catch (NullPointerException ignore) {}
        try {
            project.setProperties(obj.getProperties().stream().map(Implementacoes::tranform).toList());
        } catch (NullPointerException ignore) {}
        try{
            project.setComments(obj.getComments().stream().map(Implementacoes::tranform).toList());
        }catch (NullPointerException ignore){}

        try{
            project.setValues(obj.getValues().stream().map(Implementacoes::tranform).toList());
        }catch (NullPointerException ignore){}
    ...
    public static TaskGetDTO tranform(Task obj){
        ...
        try {
            task.setLogs(obj.getLogs().stream().map(Implementacoes::tranform).toList());
        } catch (NullPointerException ignore) {}
        try {
            task.setComments(obj.getComments().stream().map(Implementacoes::tranform).toList());
        } catch (NullPointerException ignore) { }
        try {
            task.setProperties(obj.getProperties().stream().map(Implementacoes::tranform).toList());
        } catch (NullPointerException ignore) {}
        return task;
    }
    public static PageGetDTO tranform(Page obj){
        ...
        try {
            page.setProperties(obj.getProperties().stream().map(Implementacoes::tranform).toList());
        } catch (NullPointerException ignore) {
    ...
    public static GroupGetDTO tranform(Group obj){
        ...
        try {
            group.setPermissions(obj.getPermissions().stream().map(Implementacoes::tranform).toList());
        }catch (NullPointerException ignore) {}
        try {
            group.setUsers(obj.getUsers().stream().map(Implementacoes::tranformSimple).toList());
        }catch (NullPointerException ignore) {}
        return group;
    }
    ...
    public static SimpleProjectGetDTO tranformSimple(Project obj){
        ...
        return new SimpleProjectGetDTO(
                ...
                progress,groups.stream().map(Implementacoes::tranformSimple).toList(),
    ...
    public static OtherUsersDTO transformOther(User user){
        ...
        other.setPermissions(user.getPermissions().stream().map(Implementacoes::tranform).toList());
        return other;
    }
